...
<section class="ticket-show__card ticket-show__card--sectioned" aria-labelledby="operative-heading">

    <div class="ticket-show__section-head">
        <span class="ticket-show__section-badge" aria-hidden="true">2</span>
        <h2 id="operative-heading" class="ticket-show__section-head-title">Estado operativo del ticket</h2>
    </div>
