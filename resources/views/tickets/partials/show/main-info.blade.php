...
<section class="ticket-show__card ticket-show__card--sectioned" aria-labelledby="info-heading">

    <div class="ticket-show__section-head">
        <span class="ticket-show__section-badge" aria-hidden="true">1</span>
        <h2 id="info-heading" class="ticket-show__section-head-title">Información principal del ticket</h2>
    </div>
    ...
    <div class="ticket-show__card-body">
        ...
        {{-- Datos del ticket --}}
        <div class="grid grid-cols-2 gap-x-4 gap-y-3 sm:grid-cols-3 text-sm mb-5">
            <div>
        ...
        @if ($vm->canEditOperational)
            <div class="mt-5 pt-4 ticket-show__divider space-y-3">
                ...
                <div>
                    <label for="edit-priority" class="ticket-show__field-label">Prioridad</label>
