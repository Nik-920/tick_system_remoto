...
@can('updateState', $ticket)
    @if (count($vm->availableTransitions) > 0)
        <section id="update-state" class="ticket-show__card ticket-show__card--sectioned" aria-labelledby="update-state-heading">

            <div class="ticket-show__section-head">
                <span class="ticket-show__section-badge" aria-hidden="true">3</span>
                <h2 id="update-state-heading" class="ticket-show__section-head-title">Actualizar estado</h2>
            </div>
