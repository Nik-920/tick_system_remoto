                        ...
                        <div class="rep-edit__dropzone" id="edit-dropzone">
                            <label for="new-images" class="rep-edit__dropzone-label">
                                ...
                                <input id="new-images"
                                       ...
                                       data-upload-guard
                                       data-max-file-size="{{ config('tickets.media.reporter_edit.max_file_size_kb') * 1024 }}"
                                       data-max-file-size-label="{{ config('tickets.media.reporter_edit.max_file_size_mb') }} MB"
                                       data-max-files="{{ config('tickets.media.reporter_edit.max_files') }}"
                                       data-max-total-size="{{ config('tickets.media.reporter_edit.max_total_size_mb') * 1024 * 1024 }}"
                                       data-max-total-size-label="{{ config('tickets.media.reporter_edit.max_total_size_mb') }} MB"
                                       data-allowed-extensions="{{ implode(',', config('tickets.media.reporter_edit.allowed_extensions')) }}"
