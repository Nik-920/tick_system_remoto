{{-- ── SINGLE COMMUNITY COMMENT / REPLY ──────────────────────────────
     ...
     Used for both root comments and one-level replies — identical body,
     header and edit/delete/report actions. The "Responder" form lives in
     comments.blade.php and is rendered only for root comments.
