...
/**
 * Real "Editar ticket" for the reporter — phase 3.
 *
 ...
 * priority); state and assignment columns can never be written. There is NO
 * delete/destroy and NO real "Cancelar solicitud" yet.
 */
class ReporterTicketEditPageTest extends TestCase
{
    ...
    public function test_reporter_can_view_edit_form_for_own_open_unassigned_ticket(): void
    {
        ...
        $response->assertSeeText('Actualiza los datos de tu solicitud antes de que mantenimiento la tome.');
